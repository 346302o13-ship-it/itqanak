...
// The student's own view of a payment receipt image they uploaded, so the
// in-chat "receipt submitted" card can preview it on the public host (the admin
// image route lives on the admin host only). `getPaymentReceipt` self-scopes a
// student principal to their own submissions.
