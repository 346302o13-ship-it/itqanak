...
export const metadata = { title: "Page content management" };
export const dynamic = "force-dynamic";

export default async function EnglishAdminContentPage({ searchParams }: ContentPageProps) {
  const [principal, csrfToken, query] = await Promise.all([
    requireAdminPagePrincipal("/en/admin/content", "en", "admin.content.read"),
    csrfTokenForPage(),
    searchParams,
  ]);
