...
export const metadata = { title: "المراسلة والإعلانات" };
export const dynamic = "force-dynamic";

export default async function ArabicAdminMessagingPage({ searchParams }: PageProps) {
  const [principal, csrfToken, query] = await Promise.all([
    requireAdminPagePrincipal("/ar/admin/messaging", "ar", "admin.operations.read"),
    csrfTokenForPage(),
    searchParams,
  ]);
