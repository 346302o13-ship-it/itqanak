...
const landingCopy = {
  hero: {
    eyebrow: "كل ما يحتاجه الطالب",
    title: "خدمات دراستك كلها،",
    highlightedTitle: "في مكان واحد.",
    description:
      "من الواجب اليومي إلى بحثك ومشروع تخرجك وموقعك الإلكتروني — اختر الخدمة، أرسل التفاصيل، وتابع كل تحديث من جوالك. تبدأ من ١٥ ريالاً فقط.",
    status: "الخدمات متاحة الآن",
    ...
    imageAlt: "لقطة توضح متابعة الطلب وملفاته من بوابة الطالب في منصة إتقانك",
    priceChips: [
      "الواجبات من ٢٠ ر.س",
  ...
  trustItems: [
    {
      ...
      description: "واجبات، بحوث، عروض، مشاريع ومواقع — من نافذة واحدة بدل التنقل بين أشخاص.",
    },
    {
      icon: "message",
      title: "تابع من جوالك",
      description: "إشعار فوري عند كل رد أو تحديث، وملفاتك محفوظة في حسابك ترجع لها وقت ما تبي.",
    },
    {
      icon: "sparkles",
      title: "بأسعار رمزية",
      description: "تبدأ من ١٥ ريالاً، والسعر النهائي واضح ومتفق عليه قبل أن نبدأ العمل.",
    },
  ],
  services: {
    eyebrow: "الأكثر طلباً",
    title: "كل اللي تحتاجه كطالب — في مكان واحد",
    description:
      "اخترنا لك الخدمات الأكثر طلباً بأسعارها التقريبية. اضغط الخدمة لتفتح تفاصيلها وتبدأ طلبك.",
    items: [
      {
        icon: "document",
        emoji: "📚",
        ...
        description: "نراجع حلّك، نصحّح الأخطاء، ونوضّح لك الفكرة خطوة بخطوة — لتسلّم بثقة.",
      ...
      },
      {
        ...
        description: "عرض تقديمي متناسق وجذّاب لأي مادة، جاهز للطباعة أو العرض المباشر.",
      ...
      },
      {
        ...
        description: "توجيه عملي لفكرة المشروع وخطته وتنفيذه ومناقشته، من البداية حتى التسليم.",
