...
const landingCopy = {
  ...
  compare: {
    eyebrow: "إتقانك أم واتساب؟",
    title: "لماذا المنصة أفضل من محادثة واتساب",
    description:
      "واتساب ممتاز للدردشة، لكنه لم يُصمَّم لإدارة طلب دراسي من أوله لآخره. إليك الفرق.",
    whatsappTitle: "على واتساب",
    whatsappPoints: [
      "الطلبات والملفات تضيع وسط الرسائل، ويصعب الرجوع لها لاحقاً",
      "لا سعر مكتوب ولا فاتورة ولا إثبات دفع منظّم",
      "لا تعرف حالة طلبك: مقبول؟ قيد التنفيذ؟ جاهز؟",
      "الرقم قد يتغيّر، والمحادثة قد تُحذف، ولا سجل موثّق",
      "لا فصل بين طلباتك المختلفة — كلها في محادثة واحدة",
    ],
    platformTitle: "على إتقانك",
    platformPoints: [
      "كل طلب بملفاته ومراسلاته في مكان واحد، محفوظ ومنظّم",
      "سعر واضح قبل البدء، وفاتورة ومستحقات وإيصالات داخل حسابك",
      "متابعة لحظية لحالة كل طلب مع إشعار على جوالك عند أي تغيير",
      "حساب دائم موثّق، وسجل كامل لا يضيع",
      "محادثة الدعم + المساعد الذكي + مجموعة الإعلانات، وكلٌّ في مكانه",
    ],
  },
  why: {
