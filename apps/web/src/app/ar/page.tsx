  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'نعم، تعرض معظم الخدمات سعرًا تقريبيًا للبداية ("يبدأ من")، وبعض الخدمات يُحدَّد سعرها بعد الاستفسار في المحادثة. السعر النهائي يُحدَّد بعد مراجعة نطاق طلبك وملفاته وموعده.',
      },
      {
