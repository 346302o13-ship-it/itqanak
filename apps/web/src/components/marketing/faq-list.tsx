  ...
  return (
    <div className="grid gap-3">
      {items.map((item, index) => (
        <details
          className="group rounded-[var(--itq-radius-card)] border border-[var(--itq-color-border)] bg-[var(--itq-color-surface)] px-5 open:border-[var(--itq-color-brand-200)] sm:px-6"
          key={item.question}
          open={index === 0}
        >
